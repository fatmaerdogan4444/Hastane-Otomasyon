...
namespace HASTANEeee
{
    public partial class KayıtOl : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)//Kayıt Ol
        {
            ...
            baglanti.Open();
            string q = "insert hastalar (TC,adi,soyadi,DogumTarihi,DogumYeri,anneAdi,babaAdi,CepTel,Cinsiyeti,Parola) values (" + textBox1.Text + ",'" + textBox2.Text + "','" + textBox3.Text + "','" + dateTimePicker1.Text + "','" + textBox4.Text + "','" + textBox5.Text + "','" + textBox6.Text + "','" + textBox8.Text + "','" + c + "','" + textBox9.Text + "')";

...
namespace HASTANEeee
{
    public partial class PoliklinikEkle : Form
    {
        ...
        void poliklinikBilgiGetir()
        {
            ...
            baglanti.Open();
            da = new SqlDataAdapter("select * from poliklinikler", baglanti);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string sorgu = "insert into poliklinikler(poliklinikAdi) values (@poliklinikAdi)";
        ...
        {
            string sorgu = "delete from poliklinikler where poliklinikID = @poliklinikID";
            komut = new SqlCommand(sorgu, baglanti);
